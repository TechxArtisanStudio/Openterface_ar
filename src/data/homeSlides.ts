...
export const homeSlides: HomeSlide[] = [
  {
    ...
    secondaryCta: { label: 'عرض المنتج', href: '/products/keymod/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'عرض المنتج', href: '/products/kvm-go/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'عرض المنتج', href: '/products/minikvm/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'عرض الملحقات', href: '/products/accessories/' },
