...
export const accessorySkus: AccessorySku[] = [
  {
    title: "ملحقات Openterface",
    description: "ملحقات أساسية تشمل محولات الفيديو والكابلات عالية السرعة وحلول التخزين. عزز تجربتك مع Openterface باستخدام معدات عالية الجودة من TxA Shop.",
...
export const accessoriesProduct: Product = {
  ...
  slogan: "أكمل إعداداتك",
  subtitle: "كابلات ومحولات وحقائب أدوات احترافية عالية الجودة.",
  status: 'shipping',
  description:
  ...
  seoDescription:
    "ملحقات Openterface — كابلات، محولات، حقائب أدوات، وموصلات فيديو.",
  keywords: "ملحقات KVM, كابل HDMI, كابل USB-C, حقيبة أدوات",
  ...
  painPoints: [
    "عدم توفر الكابل المناسب في الميدان يؤخر كل عملية إصلاح",
  ],
  solutions: [
    "ملحقات مختبرة بعناية ومتوافقة مع منتجات Openterface",
  ],
  hwFeatures: [
    { title: "محولات الفيديو", description: "موصلات HDMI وVGA ومتخصصة." },
    { title: "كابلات عالية السرعة", description: "كابلات USB-C وType-A مصممة لأعباء عمل KVM." },
    { title: "حقيبة الأدوات", description: "نظّم مجموعة Openterface الكاملة الخاصة بك." },
  ],
  swFeatures: [],
  specs: [
  ...
  useCases: [
    "تنظيم مجموعة الميدان",
    "تحويل تنسيقات الفيديو",
    "كابلات احتياطية للحقائب المتنقلة",
  ],
  useCaseCards: [
    {
  ...
  docLinks: [
    { label: "جميع المنتجات (SKUs)", href: docsPath("/product/accessories/") },
    { label: "متجر TxA Shop", href: docsPath("https://shop.techxartisan.com") },
  ],
