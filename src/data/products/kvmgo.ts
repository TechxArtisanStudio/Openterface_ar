...
export const kvmgoProduct: Product = {
  slug: 'kvm-go',
  title: "سلسلة Openterface KVM-GO",
  slogan: "جهاز KVM فائق الصغر يناسب سلسلة مفاتيحك",
  subtitle: "للحظات التقنية الحرجة — وصّل. تحكم. انطلق.",
  status: 'pre-order',
  description:
    "حل KVM-over-USB من الجيل التالي مع موصلات فيديو مدمجة (HDMI أو DisplayPort أو VGA). فائق الصغر بحجم سلسلة المفاتيح، ومصمم لعمليات تكنولوجيا المعلومات السريعة في مراكز البيانات وغرف الخوادم.",
  seoDescription:
    "تحكم في أجهزة الكمبيوتر عديمة الشاشة باستخدام Openterface KVM-Go. موصلات HDMI/DP/VGA مدمجة، بحجم سلسلة المفاتيح، جهاز KVM-over-USB بدقة 4K لمحترفي تكنولوجيا المعلومات.",
  keywords:
    "KVM-Go, KVM عبر USB, جهاز KVM فائق الصغر, KVM بحجم سلسلة المفاتيح, KVM بدقة 4K, التحكم عديم الشاشة",
  ...
  buyLabel: "اطلب مسبقاً الآن",
  buyHref: siteConfig.links.kvmgoPurchase,
  funding: { amount: "$101,548", date: "تم التمويل في 30 ديسمبر 2025", backers: "478" },
  painPoints: [
    "معدات KVM التقليدية ضخمة وتتطلب كابلات فيديو منفصلة",
    "يتطلب الوصول الطارئ إلى الخوادم في الميدان أداة بحجم الجيب",
    "استكشاف الأخطاء وإصلاحها في الأجهزة عديمة الشاشة دون اتصال بالشبكة عملية بطيئة",
  ],
  solutions: [
    "تقضي موصلات الفيديو المدمجة على الحاجة إلى الكابلات الإضافية",
    "تصميم بحجم سلسلة المفاتيح يكون دائماً في متناول اليد",
    "KVM-over-USB — لا يتطلب شبكة أو برامج تشغيل على الجهاز المستهدف",
  ],
  hwFeatures: [
    { title: "فيديو مدمج", description: "نماذج HDMI أو DisplayPort أو VGA — بدون كابلات متدلية." },
    { title: "بحجم سلسلة المفاتيح", description: "أصغر جهاز KVM-over-USB في مجموعة منتجات Openterface." },
    { title: "دعم 4K", description: "التقاط عالي الدقة للشاشات الحديثة." },
  ],
  swFeatures: [
    { title: "تطبيق Openterface Qt", description: "تحكم متعدد المنصات للأجهزة المضيفة على Windows وmacOS وLinux." },
    { title: "مفتاح MicroSD", description: "تخزين قابل للتبديل لصور أنظمة التشغيل والأدوات المحمولة." },
    { title: "مكدس مفتوح المصدر", description: "برامج ثابتة وتطبيقات مضيفة يقودها المجتمع." },
  ],
  specs: [
    { label: "الفيديو", value: "HDMI / DP / VGA (يعتمد على الطراز)" },
    { label: "الدقة", value: "تصل إلى 4K" },
    { label: "الاتصال", value: "USB-C KVM-over-USB" },
  ],
  useCases: [
    "جولات مراكز البيانات",
    "إعداد الأجهزة عديمة الشاشة",
    "إنقاذ تكنولوجيا المعلومات الميدانية والمختبرات المنزلية",
  ],
  useCaseCards: [
    {
  ...
  docLinks: [
    { label: "الميزات", href: docsPath("/product/kvm-go/features/") },
    { label: "دليل البدء السريع للإصدار التجريبي", href: docsPath("/product/kvm-go/beta-quick-start/") },
    { label: "كيفية الاتصال", href: docsPath("/product/kvm-go/how-to-connect/") },
    { label: "الأسئلة الشائعة", href: docsPath("/product/kvm-go/faq/") },
